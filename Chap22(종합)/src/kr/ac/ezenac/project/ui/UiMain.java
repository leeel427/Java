package kr.ac.ezenac.project.ui;
...
import kr.ac.ezenac.project.school.view.GenerateGradeDisplay;
 ...
 * 		단순히 A~F를 부여하는 방법, S~F르 부여하는 방법등이 있습니다.
 * 		
 ...
 * 		======================================================
 * 
 * 		학점 정책이 추가되는 경우를 고려해서 객체를 설계하고 인터페이스를 선언해서 
 ...
 * 5. 업그레이드
 * 	- 과목과 학점 정책이 추가
 * 		- 골프 과목이 새로 개설되고 이 과목의 평가 정책은 pass/fail 로 정해졌습니다.
 * 		- 70점 이상이면 pass, 미만인 경우는 fail입니다.
